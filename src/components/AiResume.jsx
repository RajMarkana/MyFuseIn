                ...
                <div data-aos="fade-down" data-aos-duration="1500" className="px-8 flex flex-col justify-center  items-center">
                    <div className=' w-fit'>
                        ...
                        <div className="col-span-1 px-4 py-2 rounded-full shadow bg-gradient-to-r from-primary to-primary-second text-white mb-10 w-fit space-x-4">
                            <button className='flex justify-center items-center '><img src="./aiIcon2.png" className='mr-2 animate-pulse-rotate ' style={{animationDuration: '3s',animationIterationCount: 'infinite' ,animationTimingFunction: 'ease-in-out' }} width={20} alt="" /><p>Create Now</p></button>
                        </div>
