    ...
    return (
        <div className="flex flex-col md:flex-row items-center w-6/6 justify-between md:py-0 sm:pt-16">
            ...
            <div className="p-8 flex flex-col justify-center items-center">
                <div data-aos="fade-down" data-aos-duration="1000">
                    ...
                    <div  className="col-span-1  space-x-4">
                        <button className="px-4 py-2 flex items-center gap-1 rounded-full shadow bg-gradient-to-r from-primary to-primary-second text-white mb-10">Explore More<FaAngleRight /></button>
            ...
            <div data-aos="zoom-in" data-aos-duration="1000"  className="flex justify-center items-center w-5/5  px-8">
                ...
                <img src="./hero.png" width={800} alt="Hero Image" className="w-[800px] rounded-lg" />
