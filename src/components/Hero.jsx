        ...
        <div className="flex flex-col md:flex-row items-center w-6/6 justify-between md:py-0 sm:pt-16">
            ...
            <div className="px-8 flex flex-col justify-center items-center">
                <div data-aos="fade-down" data-aos-duration="1000">
                    ...
                    <h1  className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-8"><span className='px-1 bg-primary text-white leading-relaxed mr-2'>Unleash </span> Yourr Potential With  <br />Limitless Opportunities</h1>
